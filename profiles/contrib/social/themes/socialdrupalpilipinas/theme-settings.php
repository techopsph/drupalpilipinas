...
function socialdrupalpilipinas_form_system_theme_settings_alter(&$form, \Drupal\Core\Form\FormStateInterface &$form_state, $form_id = NULL) {
  ...
  if($system_theme_settings == 'socialdrupalpilipinas' || $system_theme_settings == 'socialsaas') {
